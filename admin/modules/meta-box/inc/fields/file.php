	...
	class RWMB_File_Field
	{
		...
		static function wp_ajax_delete_file()
		{
			...
			if ( $ok )
				...
				RW_Meta_Box::ajax_response( __( 'Error: Cannot delete file', 'locality' ), 'error' );
		}
		...
		{
			$i18n_delete = _x( 'Delete', 'file upload', 'locality' );
			$i18n_title  = _x( 'Upload files', 'file upload', 'locality' );
			$i18n_more   = _x( '+ Add new file', 'file upload', 'locality' );
