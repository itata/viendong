...
if ( ! class_exists( 'RW_Meta_Box' ) )
{
	...
	class RW_Meta_Box
	{
					...
					<script type="text/javascript">
						if ( typeof rwmb == "undefined" )
						{
							var rwmb = {
								...
								summaryMessage : "' . __( 'Please correct the errors highlighted below and try again.', 'locality' ) . '"
							};
						}
						else
						{
		...
		static function end_html( $html, $meta, $field )
		{
			...
			$button = '';
			if ( $field['clone'] )
				$button = '<a href="#" class="rwmb-button button-primary add-clone">' . __( '+', 'locality' ) . '</a>';
		...
		{
			$button = '<a href="#" class="rwmb-button button remove-clone">' . __( '&#8211;', 'locality' ) . '</a>';
