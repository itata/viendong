	...
	class RWMB_Plupload_Image_Field extends RWMB_Image_Field
	{
		...
		static function admin_enqueue_scripts()
		{
			...
			wp_localize_script( 'rwmb-plupload-image', 'rwmb_plupload_defaults', array(
				...
				'filters'             => array(
					array(
						'title'      => _x( 'Allowed Image Files', 'image upload', 'locality' ),
		...
		static function html( $html, $meta, $field )
		{
			...
			$i18n_drop   = apply_filters( 'rwmb_upload_drop_string', _x( 'Drop images here', 'image upload', 'locality' ) );
			$i18n_or     = _x( 'or', 'image upload', 'locality' );
			$i18n_select = _x( 'Select Files', 'image upload', 'locality' );
			$img_prefix  = $field['id'];
